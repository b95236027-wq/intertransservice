...
<header class="bg-[#0f2942] text-white sticky top-0 z-50">
	<!-- Top bar with contact info -->
	<div class="bg-[#0a1f33] border-b border-white/10">
		<div class="container mx-auto px-4 py-2 flex justify-between items-center text-sm">
			<div class="flex items-center gap-6">
				<a href="tel:+77019134104" class="flex items-center gap-2 text-gray-300 hover:text-white transition-colors">
					<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
					</svg>
					+7 701 913 41 04
				</a>
				<a href="mailto:its_aktau@mail.ru" class="hidden sm:flex items-center gap-2 text-gray-300 hover:text-white transition-colors">
					<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
	...
	<div class="container mx-auto px-4">
		<div class="flex items-center justify-between py-4">
			...
			<a href="/" class="flex items-center gap-3">
				...
				<div class="hidden sm:block">
					...
					<div class="text-xs text-gray-400 tracking-wider uppercase">Аренда спецтехники</div>
				</div>
			</a>
			...
			<nav class="hidden lg:flex items-center gap-1">
				<div class="relative group">
					...
					<div class="absolute left-0 mt-0 w-56 bg-[#0f2942] border border-white/10 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
						<a href="/about" class="block px-4 py-3 text-gray-300 hover:text-white hover:bg-white/5 border-b border-white/5">О компании</a>
						<a href="/about/quality" class="block px-4 py-3 text-gray-300 hover:text-white hover:bg-white/5 border-b border-white/5">Качество и безопасность</a>
						<a href="/about/team" class="block px-4 py-3 text-gray-300 hover:text-white hover:bg-white/5">Наша команда</a>
					</div>
				</div>
				<a href="/products" class="nav-link px-4 py-2 text-gray-200 hover:text-white transition-colors">Услуги</a>
		...
		{#if mobileMenuOpen}
			<nav class="lg:hidden border-t border-white/10 py-4 space-y-1">
				<a href="/about" class="block py-3 px-4 text-gray-200 hover:text-white hover:bg-white/5" onclick={closeMobileMenu}>О компании</a>
				<a href="/products" class="block py-3 px-4 text-gray-200 hover:text-white hover:bg-white/5" onclick={closeMobileMenu}>Услуги</a>
