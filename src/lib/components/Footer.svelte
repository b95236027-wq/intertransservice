...
<footer class="bg-[#0a1f33] text-gray-300">
	...
	<div class="container mx-auto px-4 py-16">
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
			...
			<!-- Information Links -->
			<div>
				<h4 class="text-white font-bold mb-4 text-sm">{m.footer_section_info()}</h4>
			...
			<!-- Products/Services -->
			<div>
				<h4 class="text-white font-bold mb-4 text-sm">{m.footer_section_services()}</h4>
				<ul class="space-y-2 text-xs">
			...
			<!-- Contact Information -->
			<div>
				<h4 class="text-white font-bold mb-4 text-sm">{m.footer_section_contacts()}</h4>
				<ul class="space-y-2 text-xs">
					<li class="flex items-start gap-2">
						<svg class="w-3 h-3 text-[#c9a227] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<li class="flex items-start gap-2">
						...
						<div>
							<span class="text-white">Актау, Казахстан</span>
						</div>
					</li>
					<li class="flex items-start gap-2">
						<svg class="w-3 h-3 text-[#c9a227] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						...
						<div>
							<a href="mailto:its_aktau@mail.ru" class="text-white hover:text-[#c9a227]">its_aktau@mail.ru</a>
						</div>
					</li>
				</ul>
			</div>
